...
HEADERS := drawable.hpp game_screen.hpp player.hpp game_state_menu.hpp buttons.hpp obstacle.hpp window_part.hpp sprite_factory.hpp builder.hpp simple_functions.hpp init_game.hpp label.hpp game_state_shop.hpp game_state_game.hpp game_state_dead.hpp game_states.hpp game_object.hpp

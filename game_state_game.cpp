...
{
    drawables = {&left, &game_window, &right, &display_coins, & quit_gamewindow, &back_to_menu_gamewindow, &player1};
    updatables = {&left,&right, &game_window, &display_coins, & quit_gamewindow, &back_to_menu_gamewindow, &player1, &builder1};
